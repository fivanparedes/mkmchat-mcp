...
async def ask_assistant(
    ...
    """
    Ask the AI assistant a question about the game
    ...
    try:
        ...
        assistant = get_gemini_assistant(rag_system=rag)
        ...
        if not assistant.enabled:
            return {
                "content": [
                    {
                        "type": "text",
                        "text": "Gemini assistant not available. Please set GEMINI_API_KEY environment variable.\n\nGet your API key from: https://makersuite.google.com/app/apikey"
                    }
                ]
            }
...
async def compare_characters_llm(
    character1: str,
    character2: str
) -> Dict[str, Any]:
    """
    Compare two characters using AI analysis
    ...
    try:
        ...
        logger.error(f"Error in compare_characters_llm: {e}")
        return {
            "content": [
                {
                    "type": "text",
...
async def suggest_team_llm(
    strategy: str,
    owned_characters: Optional[List[str]] = None
) -> Dict[str, Any]:
    """
    Get AI-powered team composition suggestions
    ...
    try:
        ...
        logger.error(f"Error in suggest_team_llm: {e}")
        return {
            "content": [
                {
                    "type": "text",
...
async def explain_mechanic_llm(
    mechanic: str
) -> Dict[str, Any]:
    """
    Get detailed AI explanation of a game mechanic
    ...
    try:
        ...
        logger.error(f"Error in explain_mechanic_llm: {e}")
        return {
            "content": [
                {
                    "type": "text",
